...
<html lang="pt-br">
    ...
    <head>
       ...
       <!-- <script src= "https://github.com/google/gson.git"></script>-->
        ...
        <link rel="stylesheet" href="./bodyMoagemLinha01.css">
        <link rel="stylesheet" href="./caixaMoagemLinha01.css">
        <link rel="stylesheet" href="./labelMoagemLinha01.css">
        <link rel="stylesheet" href="./menuMoagemLinha01.css">
    </head>
    ...
    <body>
        <div>
                ...
                <div class="dropdown-content">
                    <li>
                        ...
                        <ul>
                            ...
                            <li>    <a href="./MoagemLinha01.php">                                                      Moagem - Linha 01                   </a></li>
            ...
            <label id="MoagemLinha01SupervisaoGeral"    type="text" name="MoagemLinha01SupervisaoGeral">    Moagem - Linha 01 - Supervisão Geral    </label>
            ...
            <div id="MoagemCaixa02"  type="text" name="MoagemCaixa02"> VPT-2030-CI-001  </div>
            <div id="MoagemCaixa03"  type="text" name="MoagemCaixa03"> VPT-2030-DI-001  </div>
            <div id="MoagemCaixa04"  type="text" name="MoagemCaixa04"> VPT-2030-MO-001  </div>
            ...
            <div id="MoagemCaixa07"  type="text" name="MoagemCaixa07"> 2040-BP-001      </div>

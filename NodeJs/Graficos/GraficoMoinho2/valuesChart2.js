$(document).ready(function(){
    ...
    selectedTagA = "Moagem_MO02_CargaCirculante_Percentual_OptProcess";
    selectedTagB = "Moagem_MO02_CargaCirculante_Percentual_sp_OptProcess";
    selectedTagC ="Moagem_CX02_VazaoAgua_OptSim";
    selectedTagD ="Moagem_CI02_Pressao_OptProcess";
    selectedTagE ="Moagem_MO02_Potencia_Especifica_OptProcess";
    selectedTagF ="Moagem_CI02_Alimentacao_Densidade_OptSim";
    selectedTagG ="Moagem_CI02_OF_Retido_mesh100_OptSim";
    selectedTagH ="Moagem_CI02_OF_Retido_mesh100_sp_OptProcess";

$(document).ready(function(){
    ...
    selectedTagA =  "Espessamento_Rejeito_OF_Taxa_BaseSeca_Final_OptSim";
    selectedTagB =  "Espessamento_Rejeito_OF_Taxa_BaseUmida_Final_OptSim";
    selectedTagC =  "Espessamento_Rejeito_OF_Teor_Fe_Final_OptSim";
    selectedTagD =  "Espessamento_Rejeito_OF_Teor_SiO2_Final_OptSim";
...
*/
				...
				for(i=0; i<tagA.length; i++)	tagA[i] = tagA[i]/maxA * 50;
				for(i=0; i<tagB.length; i++)	tagB[i] = tagB[i]/maxB * 50;
				for(i=0; i<tagC.length; i++)	tagC[i] = tagC[i]/maxC * 50;
				for(i=0; i<tagD.length; i++)	tagD[i] = tagD[i]/maxD * 50;

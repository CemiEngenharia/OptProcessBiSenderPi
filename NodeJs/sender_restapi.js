...
//MongoClient.connect(firstMongoUrl, { "useUnifiedTopology": true, /*directConnection :true, keepAlive: false, maxPoolSize:20/*, autoReconnect: true*/},   async function(err, client) {
//    if(err) throw err
//    
...
MongoClient.connect(secondMongoUrl, { "useUnifiedTopology": true, /*directConnection :true, keepAlive: false, maxPoolSize:20/*, autoReconnect: true*/},   async function(err, client) {
    if(err) throw err
...
MongoClient.connect(thirdMongoUrl, { "useUnifiedTopology": true, /*directConnection :true, keepAlive: false, maxPoolSize:20/*, autoReconnect: true*/},   async function(err, client) {
    if(err) throw err
...
//                        findAndModifyTags(__postBody['data'], firstDatabase, 0, null, null);
                        findAndModifyTags(__postBody['data'], secondDatabase, 0, null, null);
                        findAndModifyTags(__postBody['data'], thirdDatabase, 0, res, null);
                    }
                    else
                    {
